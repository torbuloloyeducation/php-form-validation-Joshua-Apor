<?php
$nameErr = $emailErr = $phoneErr = $websiteErr = $genderErr = $passwordErr = $confirmpassErr = $termsErr = "";
$name = $email = $phone = $website = $comment = $gender = $password = $confirmpass = "";
$attempt = 0;
$submitted = false;
...
$formValid = $submitted && empty($nameErr) && empty($emailErr) && empty($genderErr) && empty($phoneErr) && empty($websiteErr) && empty($passwordErr) && empty($confirmpassErr) && empty($termsErr);
?>
...
<div class="form-container">
    ...
    <form method="post" action="<?= htmlspecialchars($_SERVER["PHP_SELF"]) ?>">
        ...
        <div class="field-row">
            ...
            <input type="text" id="phone" name="phone" placeholder="09123456789" value="<?= $phone ?>">
        ...
        <div class="field-row">
            <label>Password <span style="color:var(--error-red)">*</span></label>
            <input type="password" name="password">
            <?php if($passwordErr): ?><span class="error"><?= $passwordErr ?></span><?php endif; ?>
        </div>

        <div class="field-row">
            <label>Confirm Password <span style="color:var(--error-red)">*</span></label>
            <input type="password" name="confirm_password">
            <?php if($confirmpassErr): ?><span class="error"><?= $confirmpassErr ?></span><?php endif; ?>
        </div>
